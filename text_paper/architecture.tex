...
\begin{figure}[h!]
 ...
 \end{figure}
\vspace{0cm}
\paragraph{\textbf{1. Editors and Control Panels}\\} 
\hspace{-.2cm}
...
\paragraph{\textbf{2. From EARS to Lineal Temporal Logic}\\}
\label{sec:ears_LTL} 
\hspace{-.2cm}
...
\paragraph{\textbf{3. Synthesizing a Controller using \textsf{autoCode4}}\\}
